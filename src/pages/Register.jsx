...
export default function Register() {
  ...
  return (
    <section className=" grid h-screen place-items-center text-green-700">
        <Helmet>
        <title className="text-green-700">Register</title>
      </Helmet>

      <Form onSubmit={handleSubmit}  className="w-96 p-8 bg-base-100  flex flex-col gap-y-4 ">
