...
export default function Login() {
  ...
  return (
    <section className="text-green-700 grid h-screen place-items-center">
        <Helmet>
        <title>Login</title>
      </Helmet>
      <Form
        ...
        method="post"
        className="flex flex-col p-8 gap-y-4  w-96 bg-base-100 "
      >
        <h4 className=" text-center font-bold text-3xl text-green-700"> Login</h4>
        ...
        <p className="text-center">
          Not a member yet ?{" "}
          <Link
            className=" text-green-700 ml-2 link link-hover capitalize link-primary  "
            to="/register"
          >
        ...
        <Link className=" btn text-green-700" to={'/forgetpassword'}> ForgetPassword</Link>
      </Form>
    </section>
  );
}
